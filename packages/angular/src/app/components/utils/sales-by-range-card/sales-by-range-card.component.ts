...
@Component({
    ...
    imports: [CardAnalyticsComponent, DxPieChartModule, DxiSeriesModule, DxoLabelModule, DxoFontModule, DxoLegendModule, DxoMarginModule, DxoSizeModule, DxChartModule, DxoCommonAxisSettingsModule, DxoTickModule, DxoCommonSeriesSettingsModule, DxoSeriesTemplateModule, DxoValueAxisModule, DxoFormatModule]
})
