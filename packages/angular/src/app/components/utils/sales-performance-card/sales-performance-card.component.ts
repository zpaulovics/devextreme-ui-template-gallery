...
@Component({
    ...
    imports: [CardAnalyticsComponent, DxDropDownButtonModule, DxChartModule, DxoArgumentAxisModule, DxoTooltipModule, DxoSeriesTemplateModule, DxoCommonSeriesSettingsModule, DxoPointModule, DxoLegendModule, DxoSizeModule]
})
